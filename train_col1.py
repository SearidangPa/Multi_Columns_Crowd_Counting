...
#paths
output_save_path = './pre_trained_model_col1/'
...
writer = SummaryWriter("./runs_col1")
...
if continue_training == True:
	model_name = "pre_trained_model_col1/MCNN_col1_part_A_118.pth"
...
while epoch < 1000: 
	...
	if (epoch % 2 == 0):
		...
		save_name = os.path.join(output_save_path, '{}_{}_{}.pth'.format("MCNN_col1","part_A",epoch))
		states = {
			'epoch': epoch + 1,
