...
output_save_path = './pre_trained_model_col3/'
...
writer = SummaryWriter("./runs_col3")
...
if continue_training == True:
	model_name = "pre_trained_model_col3/MCNN_col3_part_A_78.pth"
...
while epoch < 1000: 
	...
	if (epoch % 2 == 0):
		...
		save_name = os.path.join(output_save_path, '{}_{}_{}.pth'.format("MCNN_col3","part_A",epoch))
		states = {
			'epoch': epoch + 1,
